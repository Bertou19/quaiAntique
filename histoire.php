...
$nav_en_cours = 'Histoire';



//ON définit le titre
$titrePrincipal  = "Histoire";
...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-4">
      <img class="img-histoire" src="./photos/personnel.jpg" alt="employes">
    </div>
    <h1 class="mentions-title text-center m-5">Notre histoire...</h1>

    <div class="container-fluid">
      <div class="row justify-content-center">


        <section class="col-6 text-center p-2 mb-5">
